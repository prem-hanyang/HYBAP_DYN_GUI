...
{
    public class PartPlainThrustClosedEndViewModel : PartPropertyViewModel
    {
        private PartPropertyPlainThrustClosedEnd m_Data;

        public PartPlainThrustClosedEndViewModel(PartPropertyPlainThrustClosedEnd data)
            : base()
        {
            m_Data = data;
        }
        public PartPropertyPlainThrustClosedEnd Data
        {
            get { return m_Data; }
            set
            {
